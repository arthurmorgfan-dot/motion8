...
- Stores the user's background prompt and generation settings.
- Sends background-generation requests to the MOTION8 server.
- Controls generation/loading state.
- Stores and displays generated backgrounds.
- Displays example background generations before generation.
- Switches generated results between Preview and Editor.
- Provides a responsive background creation interface.

DOES NOT CONTROL:
- PixelLab credentials or API implementation.
- Character generation or animation.
- Frame timelines.
- Background editing tools.
- Export processing.
- Authentication, billing, or database persistence.
============================================================
*/
...
>
  ...
  <span>
    ...
    {generating ? "Creating..." : "Generate"}
            ...
            <div className="order-3 mt-8 xl:order-none">
